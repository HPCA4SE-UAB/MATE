...
#ifndef __FUNCDEFEXCEPTION_H__
#define __FUNCDEFEXCEPTION_H__
...
namespace Common {
	/**
	 * @class FuncDefException
	 * @brief FuncDef exceptions.
	 *
	 * @extends Exception
	 *
	 * @version 1.0b
	...
	// ------------------------------------------------------------
	class FuncDefException: public Exception
	{
	public:
		 ...
		 * "" by default.
		 */
		FuncDefException (std::string const & msg,
